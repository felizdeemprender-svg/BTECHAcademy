...
export const TemplateViewerProduction = ({ collection, isOpen, onClose }: TemplateViewerProductionProps) => {
            ...
            {collection && (
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex gap-4">
                      <Badge variant="secondary" className="bg-purple-100 text-purple-800 border-purple-200">
                        {collection.assets?.socials?.filter((s: any) => s.platform === 'instagram').length || 0} Instagram
                      </Badge>
                      <Badge variant="secondary" className="bg-blue-100 text-blue-800 border-blue-200">
                        {collection.assets?.socials?.filter((s: any) => s.platform === 'twitter').length || 0} Twitter
                      </Badge>
                      <Badge variant="secondary" className="bg-blue-700 text-white border-blue-800">
                        {collection.assets?.socials?.filter((s: any) => s.platform === 'linkedin').length || 0} LinkedIn
                      </Badge>
                      <Badge variant="secondary" className="bg-black text-white border-gray-600">
                        {collection.assets?.socials?.filter((s: any) => s.platform === 'tiktok').length || 0} TikTok
                      </Badge>
                    </div>
                  </div>
                  ...
                  <div className="mb-6">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-md font-semibold text-pink-600">Instagram</h4>
                      <Badge variant="outline" className="text-xs">
                        {collection.assets?.socials?.filter((s: any) => s.platform === 'instagram').length || 0} posts
                      </Badge>
                    </div>
                  ...
                  <div className="mb-6">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-md font-semibold text-blue-400">Twitter</h4>
                      <Badge variant="outline" className="text-xs">
                        {collection.assets?.socials?.filter((s: any) => s.platform === 'twitter').length || 0} posts
                      </Badge>
                    </div>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                  ...
                  <div className="mb-6">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-md font-semibold text-blue-700">LinkedIn</h4>
                      <Badge variant="outline" className="text-xs">
                        {collection.assets?.socials?.filter((s: any) => s.platform === 'linkedin').length || 0} posts
                      </Badge>
                    </div>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                  ...
                  <div className="mb-6">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-md font-semibold text-black">TikTok</h4>
                      <Badge variant="outline" className="text-xs">
                        {collection.assets?.socials?.filter((s: any) => s.platform === 'tiktok').length || 0} posts
                      </Badge>
                    </div>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
