        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 12px; background-color: #ffffff;">
            <div style="text-align: center; margin-bottom: 24px;">
              <h1 style="color: #6366f1; margin: 0; font-size: 26px;">¡Bienvenido/a a Fastoria Academy!</h1>
            </div>
            ...
            <div style="text-align: center; margin: 32px 0;">
              <a href="https://fastoriaacademy.ai/auth/login" style="background-color: #6366f1; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; display: inline-block; box-shadow: 0 4px 6px -1px rgba(99, 102, 241, 0.4);">
            ...
            <p style="font-size: 14px; color: #9ca3af; margin-top: 8px; text-align: center;">
              © ${new Date().getFullYear()} Fastoria Academy. Todos los derechos reservados.
            </p>
          </div>
        `
      }
...
export async function sendTransferNotificationEmails(params: TransferEmailParams) {
  ...
  const platformUrl = 'https://fastoriaacademy.ai';
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 12px; background-color: #ffffff;">
            ...
            <p style="font-size: 13px; color: #9ca3af; margin-top: 24px; text-align: center;">
              © ${new Date().getFullYear()} Fastoria Academy.
            </p>
          </div>
        `
      }
...
export async function sendTrialEndingEmail(
  ...
  await db.collection('mail').add({
    to: tutorEmail,
    message: {
      subject: `⏰ Tu período de prueba de Fastoria termina en ${daysLeft} días`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 12px; background-color: #ffffff;">
          ...
          <div style="text-align: center; margin: 32px 0;">
            <a href="https://fastoriaacademy.ai/dashboard/plan" style="background-color: #6366f1; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; display: inline-block;">
              Ver mi plan
            </a>
          </div>
          <p style="font-size: 14px; color: #9ca3af; margin-top: 8px; text-align: center;">© ${new Date().getFullYear()} Fastoria Academy. Todos los derechos reservados.</p>
        </div>
      `
    }
  });
...
export async function sendSubscriptionActivatedEmail(
  ...
  await db.collection('mail').add({
    to: tutorEmail,
    message: {
      subject: `✅ Tu suscripción Fastoria ${planName} está activa`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 12px; background-color: #ffffff;">
          ...
          <div style="text-align: center; margin: 32px 0;">
            <a href="https://fastoriaacademy.ai/dashboard" style="background-color: #6366f1; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; display: inline-block;">
              Ir a mi panel
            </a>
          </div>
          <p style="font-size: 14px; color: #9ca3af; margin-top: 8px; text-align: center;">© ${new Date().getFullYear()} Fastoria Academy.</p>
        </div>
      `
    }
  });
...
export async function sendPaymentFailedEmail(
  ...
  await db.collection('mail').add({
    to: tutorEmail,
    message: {
      subject: `⚠️ No pudimos procesar tu pago de Fastoria`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 12px; background-color: #ffffff;">
          ...
          <div style="text-align: center; margin: 32px 0;">
            <a href="https://fastoriaacademy.ai/dashboard/payment-methods" style="background-color: #f59e0b; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; display: inline-block;">
...
export async function sendAccountSuspendedEmail(
  ...
  await db.collection('mail').add({
    to: tutorEmail,
    message: {
      subject: `🔴 Tu cuenta de Fastoria ha sido suspendida`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 12px; background-color: #ffffff;">
          ...
          <p style="font-size: 16px; color: #374151;">Hola <strong>${tutorName}</strong>,</p>
          <p style="font-size: 16px; color: #374151; line-height: 1.6;">
            Lamentablemente, tu cuenta en Fastoria Academy ha sido <strong>suspendida temporalmente</strong> debido a que no fue posible procesar el pago de tu suscripción dentro del período de gracia.
          </p>
          ...
          <div style="text-align: center; margin: 32px 0;">
            <a href="https://fastoriaacademy.ai/dashboard/payment-methods" style="background-color: #ef4444; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; display: inline-block;">
              Reactivar mi Cuenta
            </a>
          </div>
          <p style="font-size: 14px; color: #9ca3af; margin-top: 8px; text-align: center;">© ${new Date().getFullYear()} Fastoria Academy. Todos los derechos reservados.</p>
