...
export const classicStyle: LandingStyle = {
  ...
  availableSections: [
    ...
    { id: 'testimonials', name: 'Testimonios', description: 'Redacta historias de transformación de clientes que pasaron del punto de frustración al éxito gracias al método enseñado.', blueprint: 'Grilla masonry o carrusel horizontal. Tarjetas de opinión (Speech bubbles) con estrellas doradas arriba, foto miniatura del cliente, nombre, y la reseña en formato de cita.', required: false, isRepeatable: false, contentType: 'text' },
