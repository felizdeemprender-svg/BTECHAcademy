...
export default function LandingV3() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] text-[#0F172A] selection:bg-[#1CB899]/20 overflow-x-hidden font-sans">
      ...
      <section id="ecosystem" className="relative z-10 py-32 px-6 bg-white">
        <div className="container mx-auto max-w-7xl">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section id="security" className="relative z-10 py-32 px-6 overflow-hidden bg-gradient-to-b from-slate-50 via-white to-slate-50/30">
      ...
      <section id="integrations" className="relative z-10 py-32 px-6 overflow-hidden bg-slate-50/30">
